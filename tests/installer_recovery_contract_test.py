...
assert "raw_mode=Y raw_input_beta=Y skip_getfeat=N raw_no_enable=1 gate3_observe_only=1" in tool, \
    "the Gate-3 raw profile's golden base parameters are gone from the battery"
...
assert "options sl4a_spi_hid raw_mode=Y raw_input_beta=Y skip_getfeat=N raw_no_enable=1 gate3_observe_only=1 wire_double_opcode=1" in tool, \
    "the installed Gate-3 raw profile lost its golden handshake or wire_double_opcode=1 contract"
